...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/_internal/utils.mjs
// @__NO_SIDE_EFFECTS__
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/node/internal/perf_hooks/performance.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/node/console.mjs
import { Writable } from "node:stream";

// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/mock/noop.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
globalThis.console = console_default;

// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/node/internal/process/hrtime.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/node/internal/process/process.mjs
import { EventEmitter } from "node:events";

// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/node/internal/tty/read-stream.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/node/internal/tty/write-stream.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/unenv/dist/runtime/node/internal/process/node-version.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// ../../../tmp/bunx-0-wrangler@latest/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
globalThis.process = process_default;

// ../../src/adapters/repository/d1.ts
...
__name(rowToMeta, "rowToMeta");
function createD1Repository(db) {
  return {
    async save(doc) {
      await db.prepare(
        `INSERT INTO documents (slug, title, original_name, size, content_type, created_at)
           VALUES (?, ?, ?, ?, ?, ?)`
      ).bind(doc.slug, doc.title, doc.originalName, doc.size, doc.contentType, doc.createdAt.getTime()).run();
    },
    async findBySlug(slug) {
      const row = await db.prepare(`SELECT * FROM documents WHERE slug = ?`).bind(slug).first();
...
// ../../src/adapters/storage/r2.ts
function createR2Storage(bucket) {
  return {
    async put(key, data, meta2) {
      await bucket.put(
        key,
        data,
        meta2?.contentType ? { httpMetadata: { contentType: meta2.contentType } } : void 0
      );
    },
    async get(key) {
...
__name(createAnonymousAuth, "createAnonymousAuth");
...
__name(serveClientJs, "serveClientJs");
...
function Layout(props) {
  return /* @__PURE__ */ jsxDEV("html", { lang: "ja", "data-theme": "", children: [
    /* @__PURE__ */ jsxDEV("head", { children: [
      ...
      /* @__PURE__ */ jsxDEV("link", { rel: "stylesheet", href: "/static/style.css" })
    ] }),
    /* @__PURE__ */ jsxDEV("body", { children: [
      props.children,
      /* @__PURE__ */ jsxDEV("script", { type: "module", src: "/static/app.js" })
    ] })
  ] });
}
...
function HomePage(props) {
  return /* @__PURE__ */ jsxDEV("div", { children: [
    /* @__PURE__ */ jsxDEV("header", { class: "site-header", children: /* @__PURE__ */ jsxDEV("div", { class: "container", style: "display:flex;align-items:center;justify-content:space-between;width:100%", children: [
      /* @__PURE__ */ jsxDEV("a", { href: "/", class: "site-logo", children: "pagebox" }),
      /* @__PURE__ */ jsxDEV("button", { class: "theme-toggle", id: "themeToggle", children: "\u{1F319}" })
    ] }) }),
    /* @__PURE__ */ jsxDEV("main", { class: "container", children: [
      /* @__PURE__ */ jsxDEV("section", { class: "hero", children: [
        /* @__PURE__ */ jsxDEV("h1", { children: "HTML \u3092\u3001\u30C9\u30E9\u30C3\u30B0\u3059\u308B\u3060\u3051\u3067\u5171\u6709" }),
        /* @__PURE__ */ jsxDEV("p", { children: "\u81EA\u5DF1\u5B8C\u7D50\u3057\u305F HTML \u30D5\u30A1\u30A4\u30EB\u3092\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9\u3057\u3066\u3001\u3059\u3050\u306B\u5171\u6709\u53EF\u80FD\u306A URL \u3092\u767A\u884C\u3057\u307E\u3059\u3002" })
      ] }),
      /* @__PURE__ */ jsxDEV(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxDEV("div", { class: "dropzone-icon", children: "\u{1F4C4}" }),
            /* @__PURE__ */ jsxDEV("p", { children: /* @__PURE__ */ jsxDEV("strong", { children: "\u30AF\u30EA\u30C3\u30AF\u307E\u305F\u306F\u30C9\u30E9\u30C3\u30B0\uFF06\u30C9\u30ED\u30C3\u30D7" }) }),
            /* @__PURE__ */ jsxDEV("p", { children: ".html / .htm \u30D5\u30A1\u30A4\u30EB\uFF08\u6700\u5927 10MB\uFF09" }),
            /* @__PURE__ */ jsxDEV("input", { type: "file", id: "fileInput", accept: ".html,.htm", style: "display:none" })
          ]
        }
      ),
      /* @__PURE__ */ jsxDEV("div", { id: "result", class: "result-box hidden", children: [
        /* @__PURE__ */ jsxDEV("div", { class: "result-url", children: /* @__PURE__ */ jsxDEV("a", { id: "resultLink", href: "#", target: "_blank", rel: "noopener noreferrer" }) }),
        /* @__PURE__ */ jsxDEV("button", { class: "btn btn-primary", id: "copyBtn", children: "\u30B3\u30D4\u30FC" }),
        /* @__PURE__ */ jsxDEV("a", { class: "btn btn-secondary", id: "openBtn", href: "#", target: "_blank", rel: "noopener noreferrer", children: "\u958B\u304F" })
      ] }),
      /* @__PURE__ */ jsxDEV("p", { id: "errorMsg", class: "error-msg hidden" }),
      /* @__PURE__ */ jsxDEV("p", { class: "section-title", children: "\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9\u6E08\u307F" }),
      /* @__PURE__ */ jsxDEV("div", { id: "docList", class: "doc-list", children: props.documents.length === 0 ? /* @__PURE__ */ jsxDEV("div", { class: "empty-state", children: /* @__PURE__ */ jsxDEV("p", { children: "\u307E\u3060\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u304C\u3042\u308A\u307E\u305B\u3093" }) }) : props.documents.map((doc) => /* @__PURE__ */ jsxDEV("div", { class: "doc-card", id: `doc-${doc.slug}`, children: [
        /* @__PURE__ */ jsxDEV("div", { class: "doc-info", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "doc-title", children: doc.title }),
          /* @__PURE__ */ jsxDEV("div", { class: "doc-meta", children: [
            formatDate(doc.createdAt),
            " \xB7 ",
            formatSize(doc.size)
          ] })
        ] }),
        /* @__PURE__ */ jsxDEV("div", { class: "doc-actions", children: [
          /* @__PURE__ */ jsxDEV("a", { class: "btn btn-secondary", href: `/d/${doc.slug}`, target: "_blank", rel: "noopener noreferrer", children: "\u958B\u304F" }),
          /* @__PURE__ */ jsxDEV(
            "button",
            {
              class: "btn btn-secondary",
              "data-copy-url": `/d/${doc.slug}`,
              children: "URL\u30B3\u30D4\u30FC"
            }
          ),
          /* @__PURE__ */ jsxDEV(
...
function homeRoutes(deps) {
  const app = new Hono2();
  app.get("/", async (c) => {
    const docs = await listDocuments({ repo: deps.repo });
    const content = HomePage({ documents: docs });
    const page = Layout({ title: "pagebox", children: content });
    return c.html(page);
  });
  return app;
}
__name(homeRoutes, "homeRoutes");

// ../../src/core/document.ts
var MAX_UPLOAD_BYTES = 10 * 1024 * 1024;
function isHtmlUpload(name, type) {
  return /\.html?$/i.test(name) || type.includes("text/html");
}
__name(isHtmlUpload, "isHtmlUpload");
function deriveTitle(html2, fallbackName) {
  const match2 = html2.match(/<title[^>]*>([\s\S]*?)<\/title>/i);
  if (match2) {
...
async function uploadDocument(deps, input2) {
  if (!isHtmlUpload(input2.fileName, input2.contentType)) {
    throw new ValidationError("HTML \u30D5\u30A1\u30A4\u30EB\u306E\u307F\u5BFE\u5FDC\u3057\u3066\u3044\u307E\u3059");
  }
  if (input2.bytes.byteLength > MAX_UPLOAD_BYTES) {
    throw new ValidationError("\u30D5\u30A1\u30A4\u30EB\u30B5\u30A4\u30BA\u304C\u4E0A\u9650\uFF0810MB\uFF09\u3092\u8D85\u3048\u3066\u3044\u307E\u3059");
  }
  const html2 = new TextDecoder().decode(input2.bytes);
  const title3 = deriveTitle(html2, input2.fileName);
  let slug = "";
  for (let i = 0; i < 5; i++) {
  ...
  const key = `${slug}.html`;
  await deps.storage.put(key, input2.bytes, { contentType: "text/html" });
  const meta2 = {
    slug,
    title: title3,
    originalName: input2.fileName,
    size: input2.bytes.byteLength,
    contentType: "text/html",
    createdAt: /* @__PURE__ */ new Date()
  };
  await deps.repo.save(meta2);
  return meta2;
}
__name(uploadDocument, "uploadDocument");

// ../../src/core/usecases/delete-document.ts
async function deleteDocument(deps, slug) {
  const meta2 = await deps.repo.findBySlug(slug);
...
function apiRoutes(deps) {
  const app = new Hono2();
  app.post("/upload", async (c) => {
    const form2 = await c.req.formData();
    ...
    try {
      const meta2 = await uploadDocument(
        { storage: deps.storage, repo: deps.repo },
        { fileName: file.name, contentType: file.type || "text/html", bytes }
      );
      return c.json({ slug: meta2.slug, url: `/d/${meta2.slug}`, title: meta2.title }, 201);
    } catch (e) {
  ...
  app.delete("/documents/:slug", async (c) => {
    ...
    const ok = await deleteDocument({ storage: deps.storage, repo: deps.repo }, slug);
...
var worker_default = {
  async fetch(request, env2) {
    ...
    const repo = createD1Repository(env2.DB);
    const storage = createR2Storage(env2.STORAGE);
    const auth = createAnonymousAuth();
    const app = createApp({ storage, repo, auth });
